export const accountMessages: Record<string, { text: string; success?: boolean }> = {
  ...
  "hotel-archived": { text: "Hotel gearchiveerd. Nieuwe zoekopdrachten en e-mails zijn gestopt. De geschiedenis blijft bewaard.", success: true },
  "hotel-restored": { text: "Hotel hersteld. Het zoekt weer mee zodra het account actief is en de volgende zoekopdracht aan de beurt is.", success: true },
  "hotel-input": { text: "Selecteer een hotel en kies Archiveren of Herstellen." },
  "hotel-missing": { text: "Dit hotel hoort niet bij het geselecteerde account of bestaat niet meer. Vernieuw de pagina." },
  "hotel-limit": { text: "Dit account heeft geen ruimte meer voor een extra hotel. Verhoog eerst het aantal hotels." },
  "limit-saved": { text: "Het aantal hotels is opgeslagen.", success: true },
  "limit-input": { text: "Vul een heel getal van 0 of hoger in, of laat het veld leeg voor onbeperkt." },
