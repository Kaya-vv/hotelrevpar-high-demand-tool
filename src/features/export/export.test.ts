  ...
  it("groups one event by final hotel importance and keeps approved fields blank", async () => {
    const rows = mapRevControlRows(
      [{
        ...
        hotels: [
          { id: "hotel-1", code: "MATCH", importance: "High", impactBasis: "demand_rule" },
          { id: "hotel-2", code: "REINE", importance: "Medium", impactBasis: "demand_rule" },
          { id: "hotel-3", code: "PEAK", importance: "Peak", impactBasis: "demand_rule" },
          { id: "hotel-4", code: "LOW", importance: "Low", impactBasis: "demand_rule" },
    ...
    const events: ExportEvent[] = [
      {
        ...
        startAt: "2027-10-16T10:00:00+02:00",
        endAt: "2027-10-24T22:00:00+02:00",
        hotels: [{ id: "hotel-1", code: "MATCH", importance: "High", impactBasis: "demand_rule" }],
      },
      {
        id: "event-2",
        ...
        hotels: [{ id: "hotel-1", code: "MATCH", importance: "Medium", impactBasis: "demand_rule" }],
      },
      {
        id: "event-3",
        ...
        hotels: [{ id: "hotel-2", code: "OTHER", importance: "Peak", impactBasis: "demand_rule" }],
      },
    ];
